...
filepath = 'C:/Users/Deeksha Priya/Desktop/Plant-Leaf-Disease-Prediction-main/crop_model.h5'
...
def pred_tomato_dieas(tomato_plant):
  ...
  if pred==0:
      ...
      return "Pepper - Bell Bacterial Spot Disease", 'Pepper__bell___Bacterial_spot.html'
  elif pred==11:
        return "Pepper - Bell Healthy And Fresh ", 'Pepper__bell___healthy.html'
  elif pred==12:
        return "Potato - Early Blight Disease", 'Potato___Early_blight.html'
  elif pred==13:
        return "Potato - Healthy And Fresh", 'Potato___healthy.html'
  elif pred==14:
...
def predict():
     if request.method == 'POST':
        ...
        file_path = os.path.join('C:/Users/Deeksha Priya/Desktop/Plant-Leaf-Disease-Prediction-main/static/upload/', filename)
        file.save(file_path)
