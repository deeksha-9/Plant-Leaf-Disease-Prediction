...
tomato_plant = cv2.imread('C:/Users/Deeksha Priya/Desktop/Plant-Leaf-Disease-Prediction-main/Dataset/test/Tomato___Bacterial_spot (1).JPG')
...
if pred==0:
    ...
    print("Tomato - Target Spot Disease")
      ...
      print("Pepper - Bell Healthy And Fresh ")
elif pred==12:
      print( "Potato - Early Blight Disease")
elif pred==13:
      print("Potato - Healthy And Fresh")
elif pred==14:
